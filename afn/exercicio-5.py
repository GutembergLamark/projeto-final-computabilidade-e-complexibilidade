# Este AFN aceita cadeias que possuem um número ímpar de "1"s ou terminam com "0".
...
def AFN_impar_uns_ou_termina_0():
  estados = {'q0', 'q1', 'q2'}
  alfabeto = {'0', '1'}
  transicoes = {
      'q0': {'1': {'q1'}, '0': {'q2'}},
...
afn2 = AFN_impar_uns_ou_termina_0()
cadeias = ["10", "1010", "111", "1100", "10001", "1"]
for cadeia in cadeias:
    print(f"Cadeia: {cadeia} -> {'Aceita' if afn2.processar(cadeia) else 'Rejeita'}")